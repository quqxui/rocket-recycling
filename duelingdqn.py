...
ckpt_folder = os.path.join('./', task + '_dueldqn' +'_ckpt')
...
class MLP(nn.Module):
    def __init__(self, input_dim, output_dim):
        ...
        self.advantage = nn.Linear(in_features=h_dim, out_features=output_dim, bias=True)
        self.value = nn.Linear(in_features=h_dim, out_features=1, bias=True)
