...
ckpt_folder = os.path.join('./', task + '_noisydqn' +'_ckpt')
...
class MLP(nn.Module):
    def __init__(self, input_dim, output_dim):
        ...
        h_dim = 128
        self.linear = nn.Linear(in_features=self.mapping.output_dim, out_features=h_dim, bias=True)
        self.noisy1 = NoisyLinear(h_dim, h_dim)
        self.noisy2 = NoisyLinear(h_dim, h_dim)
        self.noisy3 = NoisyLinear(h_dim,output_dim)
